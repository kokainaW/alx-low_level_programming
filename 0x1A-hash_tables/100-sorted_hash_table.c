...
/**
 * sorted_list - the function for insert new node in sorted
...
/**
 * shash_table_print_rev - the function to print the key:value from ht in reverse
 * @ht: pointer to hash table
 *
 */
...
/**
 * shash_table_delete - will free hash table and all nodes
 * @ht: pointer to hash table
 *
 */
