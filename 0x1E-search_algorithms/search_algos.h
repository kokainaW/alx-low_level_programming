 ...
 *
 * @n: An Integer stored at the node.
...
/**
 * print_skiplist - Will print the elements of a singly linked list
 *
 * @list: Pointer to the head of the singly linked list with an express lane.
 *
 * Description:
...
/**
 * free_skiplist - A free the memory allocated for a singly linked list with an express lane.
 *
 * @list: Pointer to the head of the singly linked list with an express lane.
 *
 * Description:
